                        ...
                        <div class="col-sm-9">                            
                          <div id="dateragne-picker">
                           <div class="input-daterange input-group">
                            <input type="text" class="form-control year_picker @error('mjr_name') is-invalid @enderror" value="{{$year->scy_first_year}}" name="scy_first_year" placeholder="Masukkan tahun awal" />
                            <div class="input-group-prepend">
                              <span class="input-group-text">/</span>
                          </div>
                          <input type="text" class="form-control year_picker @error('mjr_name') is-invalid @enderror" value="{{$year->scy_last_year}}" name="scy_last_year" placeholder="Masukkan tahun akhir" />                
                      </div>
                  </div>                      
              </div>
          </div>

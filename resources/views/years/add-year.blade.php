               ...
               <div class="input-daterange input-group">
                ...
                @enderror 
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="str_payment_price" name="scy_payment_price" class="form-control form-control @error('scy_payment_price') is-invalid @enderror" value="{{ old('scy_payment_price') }}" placeholder="Masukan Jumlah Biaya PPDB">

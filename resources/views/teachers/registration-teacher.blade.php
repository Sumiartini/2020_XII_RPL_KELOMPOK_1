                    ...
                    <form id="submitForm"  autocomplete="off" method="POST" action="{{ url('teacher-registration') }}" novalidate="novalidate" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control form-control-rounded @error('usr_nik') is-invalid @enderror" id="input-10" name="usr_nik" placeholder="Masukan NIK" value="{{ old('usr_nik') }}">
                                @error('usr_nik')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-sm-4">
                                <label>NUPTK</label>
                                <input type="text" class="form-control form-control-rounded @error('tcr_nuptk') is-invalid @enderror" id="input-10" name="tcr_nuptk" placeholder="Masukan NUPTK" value="{{ old('tcr_nuptk') }}">
                                @error('tcr_nuptk')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>

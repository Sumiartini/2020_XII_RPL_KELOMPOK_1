                    ...
                    <div class="card-body">
                        ...
                        <form id="submitForm" id="submitForm" method="POST" action="{{ url('teacher-registration') }}" novalidate="novalidate" autocomplete="off">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <label>NUPTK</label>
                                    <input type="text" class="form-control form-control-rounded @error('tcr_nuptk') is-invalid @enderror" id="input-10" name="tcr_nuptk" placeholder="Masukan NUPTK">
                                    @error('tcr_nuptk')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <i class=""></i>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-rounded @error('teaching_history[school_name]') is-invalid @enderror" id="input-10" name="teaching_history[school_name]" placeholder="Masukan Nama Sekolah">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-rounded @error('teaching_history[subject]') is-invalid @enderror" id="input-10" name="teaching_history[subject]" placeholder="Masukan Mata Pelajaran">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-rounded @error('teaching_history[grade_or_level]') is-invalid @enderror" id="input-10" name="teaching_history[grade_or_level]" placeholder="Masukan Kelas/Tingkat">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-rounded @error('teaching_history[number_of_hours]') is-invalid @enderror" id="input-10" name="teaching_history[number_of_hours]" placeholder="Masukan Jumlah Jam">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="text" class="form-control form-control-rounded @error('teaching_history[from_year_to_year]') is-invalid @enderror" id="input-10" name="teaching_history[from_year_to_year]" placeholder="Masukan Dari Tahun/Sampai">

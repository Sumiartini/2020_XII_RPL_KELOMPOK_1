...
<div class="row pt-2 pb-2">
  <div class="col-sm-9">
    <h4 class="page-title">Alasan Tolak Pembayaran </h4>
    <ol class="breadcrumb">
  ...
  <div class="col-lg-12">
    <div class="card">
     <div class="card-body">
       ...
       <hr>
       <form method="POST" autocomplete="off" action="{{ url('school-payment/refuse-payment/'.$school_payment->stp_id)}}" id="form-validate">
        @csrf
